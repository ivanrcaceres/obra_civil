...
class purchase_order_wizard(models.Model):
    ...
    product_ids = fields.Many2many('product.product','wizard_product_rel','purchase_product_id','purchase_product_line_id', string='Products')
    ...
    def default_get(self,values):
        ...
        for pro_ids in stock_picking.move_lines:
            ...
            quant = self._cr.execute('select "id" from "stock_quant" WHERE product_id = %s order by "id"', (pro_ids.product_id.id,))
